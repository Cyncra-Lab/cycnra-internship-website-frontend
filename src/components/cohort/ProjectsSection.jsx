...
const ProjectsSection = () => (
  <>
    <section className="bg-[#02353C] p-14 text-white px-15 mt-85 h-[950px]">
      <CohortInfo />
      <h3 className="text-[26px] font-semibold mb-6 leading-[1.2]">→ Projects Worked On:</h3>
        ...
        {projects.map((proj, index) => (
          ...
          >
            ...
            <div className="px-4">
              ...
              <h5 className="text-sm mb-4 tracking-[0.15em] leading-[1.4]">{proj.subTitle}</h5>
              <p className="text-sm mb-4 tracking-[-0.02em] leading-[1.4]">{proj.description}</p>
