...
export default function AboutSection(){
    return(
        ...
        <div className="max-w-2xl space-y-8">
            <h3 className="text-3xl md:text-4xl lg:text-6xlfont-bold text-[var(--header-background)]">About the Program</h3>
            <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[var(--header-background)]">Internship That Shapes Future Tech Leaders</h4>
