...
export default function AboutSection(){
    return(
        ...
        <div className="max-w-3xl space-y-8">
            <h3 className="text-6xl font-bold text-[var(--header-background)]">About the Program</h3>
            <h4 className="text-4xl font-bold text-[var(--header-background)]">Internship That Shapes Future Tech Leaders</h4>
            ...
            <p className="text-2xl text-[var(--text-subtle-gray)]">
            Our internship last 8-6 months and are open to students and 
            recent graduates.Enjoy real project experience, mentorship and 
          ...
          <div className="max-w-xl">
            <Image src="/images/about_image.png" width={608} height={650} alt="about_image" />
          </div>
        </section>
    );
